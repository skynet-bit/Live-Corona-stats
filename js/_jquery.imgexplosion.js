...
function reinforcement(){
        ...
        audios = audios[Math.floor(Math.random()*audios.length)];

        $("#mainBody").append("<a id='reinforceAudio'></a>");

        if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
          var loc = window.location.pathname;
          loc = loc.replace("__viewer__.html","");
          $("#reinforceAudio").attr("href", "playsound:file://"+loc+audios+"')");
        }else{
          $("#reinforceAudio").attr("href", "javascript:py.link('ankiplay"+audios+"')");
        }
